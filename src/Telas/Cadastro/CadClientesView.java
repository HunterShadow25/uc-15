...
import Telas.Listagem.ListClientesView;
 ...
 * @javadoc
 */
public class CadClientesView extends javax.swing.JFrame {

    public CadClientesView() {
        initComponents();
        lblNivel.setText(UsuariosDTO.getUsuarios());
        if (UsuariosDTO.getUsuarios().equalsIgnoreCase("Operador")) { //verificando o nivel de acesso a atulizando a pagina
            jbnListagem.setVisible(false);
            jbnListagem.setEnabled(false);
        }
    }
    ...
    private void initComponents() {
        ...
        jbnListagem.setToolTipText("vai para listagem de clientes");
        ...
        txtCpf.setBackground(new java.awt.Color(222, 222, 222));
        ...
        jbnListagem.getAccessibleContext().setAccessibleDescription("vai para a listagem de clientes");
    ...
    private void jbnListagemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnListagemActionPerformed
        //troca de tela
        ListClientesView lc = new ListClientesView();
        lc.setVisible(true);
        this.dispose();
    ...
    private void jbnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnSalvarActionPerformed
        if (txtNome.getText().isBlank() || txtEmail.getText().isBlank() || txtCpf.getText().isBlank()) { //verificando se nenhum campo as vazio
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadClientesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadClientesView().setVisible(true);
            }
        });
    }
